...
> **Warning**
> On Android, this may work, but it is not 100% reliable (see [#1609](https://github.com/react-native-gigya2-webview/react-native-gigya2-webview/issues/1609) and [#1099](https://github.com/react-native-gigya2-webview/react-native-gigya2-webview/pull/1099)). Consider `injectedJavaScriptObject` instead.
