...
Before you do this, you should be familiar with the concepts in [native UI components](native-components-ios). You should also familiarise yourself with the [native code for web views](https://github.com/react-native-gigya2-webview/react-native-gigya2-webview/blob/master/apple/RNCWebViewManager.m), as you will have to use this as a reference when implementing new features—although a deep understanding is not required.
...
If you are unsure how something should be implemented from the JS side, look at [WebView.ios.tsx](https://github.com/react-native-gigya2-webview/react-native-gigya2-webview/blob/master/src/WebView.ios.tsx) in the React Native WebView source.
