...
1. Mark the WebView as being "inspectable" using the [`webviewDebuggingEnabled`](https://github.com/react-native-gigya2-webview/react-native-gigya2-webview/blob/master/docs/Reference.md#webviewDebuggingEnabled) prop
...
1. You will need to set the [`webviewDebuggingEnabled`](https://github.com/react-native-gigya2-webview/react-native-gigya2-webview/blob/master/docs/Reference.md#webviewDebuggingEnabled) prop on the WebView
